...
def create_app():
    ...
    if Config.ADMIN_EMAIL:
        ...
        logging.getLogger(__name__).info(f"ADMIN_EMAIL configured: '{admin_email}'")
        ...
        logging.getLogger(__name__).warning("ADMIN_EMAIL not set — no admin user will be configured")
